...
<body>
<link  rel="stylesheet" type="text/css" href="/vkids/Public/Css/cooperation.css"/>
	<div id="box">
<!-- Header starts -->
   <div id="header">
...
<div id="pagemain" class="container">
      <div class="containerwraper newswraper2">
           <div class="contentwraper">
               <div class="newslist">
                  <div class="newstitle"><?php echo ($list["title"]); ?></div>
                  <div class="newsback">[<a href="<?php echo U('index');?>">返回</a>]</div>
                  <div class="newsdesc"><?php echo (html_entity_decode($list["content"])); ?></div>
                  <div class="newsphoto">
                    <?php if(is_array($photos)): $i = 0; $__LIST__ = $photos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl><dd><img src="<?php echo SITE_PATH;?>Uploads/<?php echo ($vo["pic"]); ?>" /></dd><dt><?php echo ($vo["title"]); ?></dt></dl><?php endforeach; endif; else: echo "" ;endif; ?>
                  </div>
	           </div>
           </div>
      </div>
