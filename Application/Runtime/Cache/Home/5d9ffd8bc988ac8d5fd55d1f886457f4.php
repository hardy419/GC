...
<link  rel="stylesheet" type="text/css" href="/vkids/Public/Css/report.css"/>
	<div id="box">
<!-- Header starts -->
   <div id="header">
           ...
           <div class="contentwraper">
              <div class="rightColumn">
                    <div class="achievementlist">
                        <div class="newslist">
			                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="news <?php if($i == 1): ?>first<?php endif; ?>">
				                   <div class="textwraper">
				                      <div class="date"><?php echo (date("Y-m-d",$vo["date"])); ?></div>
				                      <div class="title"><a href="javascript:void(0);"><?php echo ($vo["title"]); ?></a></div>
				                      <div class="pdf"><a href="<?php echo SITE_PATH; echo ($vo["pdf"]); ?>" target="_blank"><img src="<?php echo SITE_PATH;?>Public/Img/Achievement/pdf.jpg" width="30" /></a></div>
				                   </div>
