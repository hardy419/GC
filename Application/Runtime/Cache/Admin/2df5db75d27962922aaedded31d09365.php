        ...
        <div class="span9">
				    ...
				    <?php if($type != 'forget'): ?><form >
					       <div class="input-append">
						    <a class="btn" href='<?php echo U('control',array('type'=>$type,'pid'=>$pid));?>'>Add <?php echo (ucfirst($type)); ?></a>
						    </div>
					 </form><?php endif; ?>
					</p>
				         ...
				         <table class="table table-striped">
			              ...
			              <tbody>
			               <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr <?php if($current == $vo['id']): ?>class="warning"<?php endif; ?>>
			                    ...
			                    <td>
			                    <?php if(($type == 'programmes')): ?><a href="<?php echo U('index',array('pid'=>$vo['id'],'type'=>'document'));?>">Documents</a>&nbsp;&nbsp;<?php endif; ?>
			                    <?php if(($type == 'tutors') or ($type == 'case') or ($type == 'student') or ($type == 'news')): ?><a href="<?php echo U('photos',array('pid'=>$vo['id'],'type'=>$type.'photos'));?>">Photos</a>&nbsp;&nbsp;<?php endif; ?>
			                    <a href="<?php echo U('control',array('id'=>$vo['id'],'type'=>$type,'pid'=>$pid));?>">Edit</a>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="del('<?php echo U('delNews',array('id'=>$vo['id'],'type'=>$type));?>');">Delete</a></td>
