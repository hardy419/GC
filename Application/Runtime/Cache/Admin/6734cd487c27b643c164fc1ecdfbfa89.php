				         ...
				         <table class="table table-striped">
			              ...
			              <tbody>
			               <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr <?php if($current == $vo['id']): ?>class="warning"<?php endif; ?>>
			                    ...
			                    <td>
			                    <a href="<?php echo U('clist',array('id'=>$vo['id']));?>">Edit</a>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="del('<?php echo U('delNews',array('id'=>$vo['id']));?>');">Delete</a>&nbsp;&nbsp;<a href="<?php echo U('course',array('cid'=>$vo['id']));?>">Course</a></td>
