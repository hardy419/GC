        ...
        <div class="span9">
				    ...
				    <?php if($type != 'forget'): ?><form >
					       <div class="input-append">
						    <a class="btn" href="<?php echo U('control',array('cid'=>I('get.cid')));?>">Add <?php echo (ucfirst($type)); ?></a>
						    </div>
					 </form><?php endif; ?>
					</p>
				         ...
				         <table class="table table-striped">
			              ...
			              <tbody>
			               <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr <?php if($current == $vo['id']): ?>class="warning"<?php endif; ?>>
			                    ...
			                    <td>
			                    <a href="<?php echo U('control',array('id'=>$vo['id'],'cid'=>I('get.cid')));?>">Edit</a>&nbsp;&nbsp;<a href="javascript:void(0);" onclick="del('<?php echo U('delcourse',array('id'=>$vo['id']));?>');">Delete</a></td>
