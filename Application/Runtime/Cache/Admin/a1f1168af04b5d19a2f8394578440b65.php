        ...
        <div class="span9">
				...
				<legend><?php if($list['id'] != ''): ?>Edit<?php else: ?>Add<?php endif; ?> <?php echo (ucfirst($type)); ?></legend>	
				   ...
				   <div class="control-group">
				    ...
				    <div class="controls">
				      <input type="text" id="date" name="date" check="Require" warning="Date cann't be empty" value="<?php echo (date("Y-m-d",$list["date"])); ?>" >
				    </div>
				    </div>
				    <div class="control-group">
				    ...
				    <div class="controls">
				    <input type="file" id="pic" name="pic" / ><p class="label label-important">(size:153*96)</p><?php if($list[pic] != ''): ?><span class="help-inline"><img src="<?php echo SITE_PATH;?>Uploads/<?php echo (substr($list["pic"],1)); ?>" width="100" /></span><?php endif; ?>
				    </div>
				    </div>
				   ...
				   <div class="control-group">
				    ...
				    <div class="controls">
				    <input type="text" id="sid" name="sid" value="<?php echo ($list["sid"]); ?>" >(Order from Big to Small)
				    </div>
				    </div>
				    <div class="control-group">
