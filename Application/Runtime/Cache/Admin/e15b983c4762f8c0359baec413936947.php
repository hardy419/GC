...
<div class="modal-body">
 <form id="editForm" class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo U('savep');?>">
...
jQuery(function(){
	var url='/vkids/admin.php/Admin/Cooperation/uploadPic/model/<?php echo ($type); ?>list';
  ...
  function edit(id){
	  var url="/vkids/admin.php/Admin/Cooperation/getPhoto/id/"+id;
